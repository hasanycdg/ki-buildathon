...
const bettBeziehen = {
  ...
  stages: [
    {
      id: "hk-bett-s1",
      goal: { de: "Du siehst die fünf Handgriffe einmal ganz und erkennst, woran ein gut gemachtes Bett zu sehen ist.",
              en: "You watch the five moves once in full and learn what shows a well-made bed.",
              pl: "Oglądasz pięć ruchów w całości i poznajesz, po czym widać dobrze pościelone łóżko.",
              hr: "Gledaš pet pokreta u cijelosti i prepoznaješ po čemu se vidi dobro namješten krevet.",
              sr: "Gledaš pet pokreta u celini i prepoznaješ po čemu se vidi dobro namešten krevet." },
      steps: [
        {
          type: "demo",
          scene: "bed",
    ...
    {
      id: "hk-bett-s2",
      goal: { de: "Du beziehst das Bett in der richtigen Reihenfolge und meldest, was dir dabei an der Matratze auffällt.",
              en: "You make the bed in the right order and report what you notice on the mattress while doing it.",
              pl: "Ścielisz łóżko we właściwej kolejności i zgłaszasz to, co przy tym zauważysz na materacu.",
              hr: "Namještaš krevet ispravnim redoslijedom i prijavljuješ što pritom primijetiš na madracu.",
              sr: "Nameštaš krevet ispravnim redosledom i prijavljuješ šta pritom primetiš na dušeku." },
      steps: [
        {
          type: "sequence",
    ...
    {
      id: "hk-bett-s3",
      goal: { de: "Du erkennst am fertigen Bett, was dazugehört und was nicht.",
              en: "You can tell what belongs to a finished bed and what does not.",
              pl: "Rozpoznajesz, co należy do gotowego łóżka, a co nie.",
              hr: "Prepoznaješ što spada u gotov krevet, a što ne.",
              sr: "Prepoznaješ šta spada u gotov krevet, a šta ne." },
      steps: [
        {
          type: "checklist",
...
const abreiseKontrolle = {
  ...
  stages: [
    {
      id: "hk-kontrolle-s1",
      goal: { de: "Du findest die sieben Stellen, an denen Gäste ihre Sachen vergessen.",
              en: "You find the seven spots where guests leave their things behind.",
              pl: "Znajdujesz siedem miejsc, w których goście zapominają swoje rzeczy.",
              hr: "Nalaziš sedam mjesta na kojima gosti zaborave svoje stvari.",
              sr: "Nalaziš sedam mesta na kojima gosti zaborave svoje stvari." },
      steps: [
        {
          type: "hotspot",
          scene: "room",
    ...
    {
      id: "hk-kontrolle-s2",
      goal: { de: "Du kontrollierst, bevor du reinigst, und gibst jeden Fund ungeöffnet an der Rezeption ab.",
              en: "You check before you clean, and hand every find to reception unopened.",
              pl: "Kontrolujesz, zanim posprzątasz, i każde znalezisko oddajesz nieotwarte na recepcję.",
              hr: "Provjeravaš prije nego očistiš i svaki nalaz predaješ recepciji neotvoren.",
              sr: "Proveravaš pre nego očistiš i svaki nalaz predaješ recepciji neotvoren." },
      steps: [
        {
          type: "decide",
